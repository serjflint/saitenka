"""UAX #14 line-breaking conformance + kinsoku + ruby-atomicity for :mod:`saitenka.render.linebreak`.
...
from saitenka.render.layout import NO_END, NO_START
from saitenka.render.linebreak import (
    PROHIBITED,
    break_opportunities,
    wrap_units,
)
from saitenka.render.linebreak import _lb_class as lb_class  # corpus scoping only
