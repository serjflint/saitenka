...
from saitenka.app import setup_wizard as sw
...
def test_anki_config_fragment():
    ...
    from saitenka.app.setup_wizard import anki_config_fragment as f
...
def test_default_field_for_prefers_existing_then_name_match_then_first():
    ...
    from saitenka.app.setup_wizard import _default_field_for as d
...
def test_rank_decks_biggest_first():
    from saitenka.app.setup_wizard import rank_decks
...
def test_default_known_deck_prefers_saitenka_known_then_largest():
    from saitenka.app.setup_wizard import default_known_deck as d
...
def test_intersect_default_only_keeps_available():
    from saitenka.app.setup_wizard import intersect_default as pick
