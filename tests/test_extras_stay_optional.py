...
taffylite / jamdict / OpenTelemetry (see ``pyproject.toml`` ``[project.optional-dependencies]``)
...
ENTRY_POINTS = [
    ...
    "saitenka.app.features.profiles.dependencies",  # dep builder (dictdb / scoring / wordlists / anki)
