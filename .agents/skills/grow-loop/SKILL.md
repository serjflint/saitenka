...
- When invoked by `assurance-pipeline`, return the scenario, liveness, restoration, and growth evidence;
  the additive test is an input to re-enfolding, not terminal package proof.
