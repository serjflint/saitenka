...
Mechanical inventories do not see every Protocol, callback, endpoint, wrapper, or nested value and
cannot prove authority retirement alone. Use symbol references and a focused AST/source guard when the
claimed boundary warrants enforcement.
