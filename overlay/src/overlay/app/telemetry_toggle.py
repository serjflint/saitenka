...
:func:`overlay.app.init_wizard.write_config` so comments/formatting survive and the prior file is
...
def telemetry_installed() -> bool:
    ...
    check :func:`overlay.app.telemetry.configure` makes before standing up providers (``__import__``
