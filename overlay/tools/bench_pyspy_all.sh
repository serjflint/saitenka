...
# percentiles from.
#
#   overlay/tools/bench_pyspy_all.sh                 # all benchmarks (prompts for the password once)
#   overlay/tools/bench_pyspy_all.sh scroll-jank     # just one (or several) by name
#   overlay/tools/bench_pyspy_all.sh --list          # list the benchmark names
#
...
# name|rate|bench-args  — mirrors the six *-pyspy poe tasks (see overlay/pyproject.toml).
BENCHES=(
