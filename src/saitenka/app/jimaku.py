...
def subs_cache_dir() -> Path:
    from saitenka.app.subtitle_cache import subs_cache_dir as shared_cache_dir

    return shared_cache_dir()


def subs_cache_key(video: str | os.PathLike, title: str, episode, *, resync: bool = True) -> str:
    from saitenka.app.subtitle_cache import subs_cache_key as shared_cache_key
...
def cached_subs(
    ...
    from saitenka.app.subtitle_cache import cached_subs as shared_cached_subs
...
def store_subs(
    ...
    *,
    ...
    from saitenka.app.subtitle_cache import store_subs as shared_store_subs
