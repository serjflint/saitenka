...
popup's own state (``tip.nest``, a :class:`~saitenka.app.features.tooltip.popups.PopupView`) lives on the tooltip.

Builds and blits through :mod:`saitenka.app.features.tooltip.tooltip_panel` — the leaf importing the panel
...
from saitenka.app.features.tooltip.popups import HoverInputs, PopupView, TipPorts, WordLookup
