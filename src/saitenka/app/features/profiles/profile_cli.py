...
``[profiles.<name>]`` overlays the resolver (:mod:`saitenka.app.profiles`) reads.
...
:func:`~saitenka.app.init_wizard.write_config` (tomlkit round-trip, ``.bak``, atomic) is ``pragma: no
