...
type LifecycleEffect = (
    ApplyPlaybackDeltas | ReplaySubtitleSelection | RetireCueIdentity | StopSession
)
...
type FireAndForget = ApplyPlaybackDeltas | ReplaySubtitleSelection | RetireCueIdentity
