...
from saitenka.render.flow import (
    FlowLayout,
    first_baseline,
    layout_flow,
    render_flow,
...
from saitenka.render.layout import Sinks
...
def _composite(
    ...
    from saitenka.render.layout import draw_inline
...
def document_geometry(doc: DocLayout) -> tuple[list[ScanBox], list[LinkBox]]:
    ...
    from saitenka.render.flow import flow_geometry
