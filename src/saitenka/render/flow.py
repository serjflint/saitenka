...
from saitenka.model import RGBA, LinkBox, ScanBox, Span, Style
from saitenka.render.layout import (
    Block,
    Sinks,
    Token,
    _font,
...
from saitenka.render.linebreak import wrap_units
...
def _ruby_base_tokens(box: RubyBox):
    ...
    from saitenka.render.layout import _tokenize_span
